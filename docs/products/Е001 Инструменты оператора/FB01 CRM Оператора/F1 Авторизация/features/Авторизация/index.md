...
| ------------------------------------------------------------------------ | --- | ------ |
| 123                                                                      | 123 | 123421 |
| ![](../../../../../../assets/images/Pasted%20image%2020260127173700.png) |     |        |
|                                                                          |     |        |

![](../../../../../../assets/images/authorization-process.drawio)
Скриншот:
...
## BPMN-схема процесса авторизации

![Процесс авторизации](../../../../../../assets/diagrams/authorization-process.drawio)
